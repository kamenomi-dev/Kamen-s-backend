...
// core/entry.ts
var app = new Hono2();
app.get("/apply", async (context) => {
  return context.text(`Current data: `);
});
...
// .wrangler/tmp/bundle-jmbuKU/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-jmbuKU/middleware-loader.entry.ts
